...
class PushManagerHtml implements Renderable
{
    ...
    public function script()
    {
        ...
        return <<<EOT
$('.push-manager').on('click', function() {
    swal({
        title: '选择审核人',
        input: 'select',
        ...
        inputValidator: function(value)  {
            return new Promise(function(resolve) {
                if(!value){
                    ...
                    $.ajax({
                        method: 'post',
                        url: '/admin/api/create-manager-bonus',
                        dataType: "json",
                        data: {
                            _token:LA.token,
...
EOT;
    ...
    public function render()
    {
        ...
        return '<div class="btn-group pull-right push-manager" style="margin-right: 10px"><a href="" class="btn btn-sm btn-default"><i class="fa fa-floppy-o"></i>&nbsp;通知管理审核</a></div>';
    }
}