...
class EmployeeSalesAnalyzeExportButton extends AbstractTool
{
    public function script()
    {
        $employeeId = Request::get('employee_id')?'"'.implode(",", Request::get('employee_id')).'"':'false';
    ...
    swal({
      ...
      preConfirm: function(result) {
            return new Promise(function(resolve, reject) {
                window.open('/admin/report/employee-sales-analyze/export-report/'+$employeeId+'/'+$startTimeStart+'/'+$startTimeEnd);
                swal('导出成功', '', 'success');
            });
      }, 
    }).then(function(){
