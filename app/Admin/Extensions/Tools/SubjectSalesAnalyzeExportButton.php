...
class SubjectSalesAnalyzeExportButton extends AbstractTool
{
    public function script()
    {
        $projectId = Request::get('project_id') ?: 'false';
        $subjectId = Request::get('subject_id') ?: 'false';
    ...
    swal({
      ...
      preConfirm: function(result) {
            return new Promise(function(resolve, reject) {
                window.open('/admin/report/subject-sales-analyze/export-report/'+$projectId+'/'+$subjectId+'/'+$startTimeStart+'/'+$startTimeEnd);
                swal('导出成功', '', 'success');
            });
      }, 
    }).then(function(){
